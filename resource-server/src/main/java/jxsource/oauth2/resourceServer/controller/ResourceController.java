...
@RestController
@RequestMapping(value = "/v1/availability")
public class ResourceController {
    ...
    @RequestMapping(value = "/{officeCode}/{date}", method = RequestMethod.GET, produces=MediaType.APPLICATION_JSON_VALUE)
    public String getavailableresponse(
            @PathVariable("officeCode") final String fieldOffice,
