...
public class ByteBuffer {
	...
	public ByteBuffer insert(int index, byte[] data) {
		if(index > limit) {
...
*/
	...
	public ByteBuffer replace(byte[] replace, int offset, int length) {
		return replace(replace, 0, replace.length, offset, length);
	}
	public ByteBuffer replace(byte[] replace, int replaceOffset, int replaceLength, int offset, int length) {
...
*/
	...
	public ByteBuffer replaceFirst(byte[] find, byte[] replace) {
		return replace(find, replace, 0);
	}
	public ByteBuffer replace(byte[] find, byte[] replace, int start) {
